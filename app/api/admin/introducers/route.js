...
export async function POST(request) {
  try {
    ...
    /*
     * Deliberately use midnight UTC.
     *
     * The admin UI deals in commercial agreement dates,
    ...
    /*
     * Confirm the introducer exists before invoking the
     * commercial transaction. This also gives us its name

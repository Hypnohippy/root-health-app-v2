...
function getMaturityLanguage(maturity) {
  ...
  const language = {
    ...
    strengthening: {
      evidenceLead:
        "Repeated reviews are strengthening Root's understanding of the organisation's wellbeing picture.",

      patternLead:
        "The current evidence supports a meaningful organisational pattern, although continued observation remains important.",

      interpretationLead:
        "Root considers this a credible interpretation supported by repeated evidence.",

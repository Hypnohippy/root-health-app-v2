...
function buildParticipation({
  ...
  return {
    ...
    workforceDenominatorSource: workforceBasis.source,
...
function buildOrganisationLearning(
  ...
  const ordered = chronologicalReviews(safeArray(reviews)).reverse();
...
export function buildRootExecutiveMeetingContext({
  ...
  return {
    ...
    organisation: {
      ...
      workforceSize: workforceDenominator(organisation).value,
      workforceContext: organisation?.workforceContext || null,

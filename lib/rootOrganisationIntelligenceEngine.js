  ...
  aliases.forEach((alias) => {
    ...
    if (normalisedLabel === normalisedAlias) {
      ...
      return;
        ...
        /*
     * Only allow containment when the spreadsheet
     * header contains the recognised business phrase.
     *
     * Do NOT allow the reverse.
     *
     * Example:
     * "Age" must never match "agency cost" merely
     * because the letters "age" appear inside "agency".
     */
    if (

...
const FIELD_ORIGINS = Object.freeze({
  ...
  playbook_tracker_entries: {
    tracker_id: "system_event",
    answers: "user_entered",
    created_at: "system_event",
  },
});
...
export function buildPersonalEvidenceAttribution({
  ...
  const bySource = {
    ...
    trackerSubmissions: attributePersonalEvidenceRecords({ table: "playbook_tracker_entries", records: trackerSubmissions }),
  };

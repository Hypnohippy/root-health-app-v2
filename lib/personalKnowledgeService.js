...
export function buildPersonalRootKnowledgeFromEvidence({
  ...
  const projections = {
    home: buildHomeKnowledgeProjection({ evidence, knowledge, generatedAt, presentationCandidates }),
    insights: buildInsightsKnowledgeProjection({ evidence, knowledge, generatedAt, presentationCandidates }),

export function buildRootMemoryService({
  ...
  if (firstName && positiveRecoveryCount >= 3) {
   ...
   recognition = `${firstName}, Root has noticed ${mostCommonEmotion} and ${mostCommonBodySignal} appearing close together recently. This may be a pattern worth watching gently.`;  } else if (firstName && mostCommonBodySignal) {

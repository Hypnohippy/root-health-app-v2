export function buildRootMemoryService({
  ...
  if (firstName && positiveRecoveryCount >= 3) {
    ...
    recognition = `${firstName}, `${firstName}, Root has noticed ${mostCommonEmotion} and ${mostCommonBodySignal} appearing close together recently. This may be a pattern worth watching gently.`. This may be one of the patterns worth watching gently.`;
 ...
 return {
  ...
  mostImportantObservation:
    getMostImportantObservation(memoryData),
};
}

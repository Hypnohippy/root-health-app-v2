...
export function buildOrganisationBusinessEvidenceReview({
  ...
  const reviews = chronologicalReviews(safeArray(organisationReviews).filter(Boolean));
  ...
  return {
    ...
    businessEventNotes: latestReview.business_event_notes || "",
    initiativeNotes: latestReview.initiative_notes || "",
    businessEvents,
    initiatives,
    watchItems,
